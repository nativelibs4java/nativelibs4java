...
public class DiscreteFourierTransformTest {
    ...
    public void testDoubleValues(String title, Transformer<DoubleBuffer, double[]> tr) {
    ...
    public void testFloatValues(String title, Transformer<FloatBuffer, float[]> tr) {
        FastFourierTransformer apache = new FastFourierTransformer();
        CLQueue queue = tr.getContext() == null ? null : tr.getContext().createDefaultOutOfOrderQueueIfPossible();
        for (double[] data : createTestDoubleInputs()) {
    ...
    void testDoubleTransformer(String title, Transformer<DoubleBuffer, double[]> t) throws IOException, CLException {
    ...
    void testFloatTransformer(String title, Transformer<FloatBuffer, float[]> t) throws IOException, CLException {
        CLQueue queue = t.getContext().createDefaultOutOfOrderQueueIfPossible();
        //System.out.println("Context: " + t.getContext());
