    ...
    private void initComponents() {
        ...
        settingsPanelLayout.setHorizontalGroup(
            ...
            .add(settingsPanelLayout.createSequentialGroup()
                ...
                .add(settingsPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
                    .add(org.jdesktop.layout.GroupLayout.LEADING, configFromGLCheck)
                    .add(org.jdesktop.layout.GroupLayout.LEADING, awtRenderingCheck)
                    .add(settingsPanelLayout.createSequentialGroup()
                        .add(platformCombo, 0, 521, Short.MAX_VALUE)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(detailsButt))
                    .add(deviceCombo, 0, 615, Short.MAX_VALUE))
                .addContainerGap())
        );
        ...
        simpleSettingsPanelLayout.setHorizontalGroup(
            ...
            .add(simpleSettingsPanelLayout.createSequentialGroup()
                ...
                .add(simpleSettingsPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(org.jdesktop.layout.GroupLayout.TRAILING, safestButt, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 135, Short.MAX_VALUE)
                    .add(fastestButt, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 135, Short.MAX_VALUE)
                    .add(normalButt, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 135, Short.MAX_VALUE))
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(simpleSettingsPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(jLabel3)
                    .add(jLabel5)
