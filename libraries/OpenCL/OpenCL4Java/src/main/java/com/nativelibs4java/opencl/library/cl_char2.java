...
@Union 
@Library("OpenCL") 
public class cl_char2 extends StructObject {
	public cl_char2() {
		super();
	}
	/// C type : cl_char[2]
	...
	/// C type : field1_struct
	@Field(1) 
	public cl_char2 field1(cl_char2.field1_struct field1) {
	...
	/// C type : field2_struct
	@Field(2) 
	public cl_char2 field2(cl_char2.field2_struct field2) {
	...
	/// C type : field3_struct
	@Field(3) 
	public cl_char2 field3(cl_char2.field3_struct field3) {
	...
	public cl_char2(Pointer pointer) {
		super(pointer);
	}
}
