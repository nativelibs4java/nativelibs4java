...
@Union 
@Library("OpenCL") 
public class cl_long2 extends StructObject {
	public cl_long2() {
		super();
	}
	/// C type : cl_long[2]
	...
	/// C type : field1_struct
	@Field(1) 
	public cl_long2 field1(com.nativelibs4java.opencl.library.cl_char2.field1_struct field1) {
	...
	/// C type : field2_struct
	@Field(2) 
	public cl_long2 field2(com.nativelibs4java.opencl.library.cl_char2.field2_struct field2) {
	...
	/// C type : field3_struct
	@Field(3) 
	public cl_long2 field3(com.nativelibs4java.opencl.library.cl_char2.field3_struct field3) {
	...
	public cl_long2(Pointer pointer) {
		super(pointer);
	}
}
