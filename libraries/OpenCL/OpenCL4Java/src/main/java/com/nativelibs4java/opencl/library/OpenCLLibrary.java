...
public interface OpenCLLibrary extends Library {
	...
	public interface pfn_notify extends Callback {
		/// @param voidPtr2 pfn_notify
		void invoke(Pointer charPtr1, Pointer voidPtr1, NativeSize size_t1, Pointer voidPtr2);
	}
	public interface pfn_notify2 extends Callback {
		/// @param voidPtr2 pfn_notify
		void invoke(Pointer charPtr1, Pointer voidPtr1, NativeSize size_t1, Pointer voidPtr2);
	}
	public interface pfn_notify3 extends Callback {
	 ...
	 */
	int clGetDeviceIDs(OpenCLLibrary.cl_platform_id cl_platform_id1, long cl_device_type1, int cl_uint1, PointerByReference cl_device_idPtr1, IntBuffer cl_uintPtr1);
	/**
	 * Device APIs<br>
	 * Original signature : <code>cl_int clGetDeviceIDs(cl_platform_id, cl_device_type, cl_uint, cl_device_id*, cl_uint*)</code><br>
	 * @see <a href="http://www.khronos.org/opencl/sdk/1.0/docs/man/xhtml/clGetDeviceIDs.html">Khronos Documentation for clGetDeviceIDs</a>
	 ...
	 */
	@java.lang.Deprecated 
	OpenCLLibrary.cl_context clCreateContext(NativeSizeByReference cl_context_propertiesPtr1, int cl_uint1, PointerByReference cl_device_idPtr1, OpenCLLibrary.pfn_notify arg1, Pointer voidPtr1, IntByReference cl_intPtr1);
	/**
	 * Context APIs<br>
	 * Original signature : <code>cl_context clCreateContext(cl_context_properties*, cl_uint, const cl_device_id*, pfn_notify, void*, cl_int*)</code><br>
	 ...
	 */
	OpenCLLibrary.cl_context clCreateContext(NativeSizeByReference cl_context_propertiesPtr1, int cl_uint1, OpenCLLibrary.cl_device_id cl_device_idPtr1[], OpenCLLibrary.pfn_notify arg1, Pointer voidPtr1, IntBuffer cl_intPtr1);
	/**
	 * Context APIs<br>
	 * Original signature : <code>cl_context clCreateContext(cl_context_properties*, cl_uint, const cl_device_id*, pfn_notify, void*, cl_int*)</code><br>
	 * @see <a href="http://www.khronos.org/opencl/sdk/1.0/docs/man/xhtml/clCreateContext.html">Khronos Documentation for clCreateContext</a>
	 */
	OpenCLLibrary.cl_context clCreateContext(NativeSizeByReference cl_context_propertiesPtr1, int cl_uint1, OpenCLLibrary.cl_device_id cl_device_idPtr1[], OpenCLLibrary.pfn_notify arg1, Pointer voidPtr1, IntByReference cl_intPtr1);
	/**
	 ...
	 */
	@java.lang.Deprecated 
	OpenCLLibrary.cl_context clCreateContextFromType(NativeSizeByReference cl_context_propertiesPtr1, long cl_device_type1, OpenCLLibrary.pfn_notify arg1, Pointer voidPtr1, IntByReference cl_intPtr1);
	/**
	 * Original signature : <code>cl_context clCreateContextFromType(cl_context_properties*, cl_device_type, pfn_notify, void*, cl_int*)</code><br>
	 ...
	 */
	OpenCLLibrary.cl_context clCreateContextFromType(NativeSizeByReference cl_context_propertiesPtr1, long cl_device_type1, OpenCLLibrary.pfn_notify arg1, Pointer voidPtr1, IntBuffer cl_intPtr1);
	/**
	 ...
	 */
	@java.lang.Deprecated 
	int clBuildProgram(OpenCLLibrary.cl_program cl_program1, int cl_uint1, PointerByReference cl_device_idPtr1, Pointer charPtr1, OpenCLLibrary.pfn_notify arg1, Pointer voidPtr1);
	/**
	 * Original signature : <code>cl_int clBuildProgram(cl_program, cl_uint, const cl_device_id*, const char*, pfn_notify, void*)</code><br>
	 ...
	 */
	int clBuildProgram(OpenCLLibrary.cl_program cl_program1, int cl_uint1, OpenCLLibrary.cl_device_id cl_device_idPtr1[], java.lang.String charPtr1, OpenCLLibrary.pfn_notify arg1, Pointer voidPtr1);
	/**
	 * Original signature : <code>cl_int clBuildProgram(cl_program, cl_uint, const cl_device_id*, const char*, pfn_notify, void*)</code><br>
	 * @see <a href="http://www.khronos.org/opencl/sdk/1.0/docs/man/xhtml/clBuildProgram.html">Khronos Documentation for clBuildProgram</a>
	 */
	int clBuildProgram(OpenCLLibrary.cl_program cl_program1, int cl_uint1, OpenCLLibrary.cl_device_id cl_device_idPtr1[], Pointer charPtr1, OpenCLLibrary.pfn_notify arg1, Pointer voidPtr1);
	/**
	 ...
	 * before using.<br>
	 * memobj<br>
	 * Original signature : <code>cl_int clSetMemObjectDestructorAPPLE(clSetMemObjectDestructorAPPLE_arg1_callback, void*)</code>
	 */
	 ...
	 * @deprecated use the safer methods {@link #clCreateFromGLBuffer(int, IntBuffer)} and {@link #clCreateFromGLBuffer(int, IntByReference)} instead
	 */
	@Deprecated
	OpenCLLibrary.cl_mem clCreateFromGLBuffer(cl_context context, long memFlags, int GLuint1, IntByReference intPtr1);
	/**
	 * Original signature : <code>cl_mem clCreateFromGLBuffer(GLuint, int*)</code><br>
	 ...
	 */
	OpenCLLibrary.cl_mem clCreateFromGLBuffer(cl_context context, long memFlags, int GLuint1, IntBuffer intPtr1);
	/**
	 ...
	 */
	@java.lang.Deprecated 
	OpenCLLibrary.cl_mem clCreateFromGLTexture2D(int GLenum1, int GLint1, int GLuint1, IntByReference cl_intPtr1);
	/**
	 * Original signature : <code>cl_mem clCreateFromGLTexture2D(GLenum, GLint, GLuint, cl_int*)</code><br>
	 ...
	 */
	OpenCLLibrary.cl_mem clCreateFromGLTexture2D(int GLenum1, int GLint1, int GLuint1, IntBuffer cl_intPtr1);
	/**
	 ...
	 */
	@java.lang.Deprecated 
	OpenCLLibrary.cl_mem clCreateFromGLTexture3D(int GLenum1, int GLint1, int GLuint1, IntByReference cl_intPtr1);
	/**
	 * Original signature : <code>cl_mem clCreateFromGLTexture3D(GLenum, GLint, GLuint, cl_int*)</code><br>
	 ...
	 */
	OpenCLLibrary.cl_mem clCreateFromGLTexture3D(int GLenum1, int GLint1, int GLuint1, IntBuffer cl_intPtr1);
	/**
	 ...
	 */
	@java.lang.Deprecated 
	OpenCLLibrary.cl_mem clCreateFromGLRenderbuffer(int GLuint1, IntByReference cl_intPtr1);
	/**
	 * Original signature : <code>cl_mem clCreateFromGLRenderbuffer(GLuint, cl_int*)</code><br>
	 ...
	 */
	OpenCLLibrary.cl_mem clCreateFromGLRenderbuffer(int GLuint1, IntBuffer cl_intPtr1);
	/**
	 ...
	 * @deprecated use the safer methods {@link #clGetGLObjectInfo(IntBuffer, IntBuffer)} and {@link #clGetGLObjectInfo(IntByReference, IntByReference)} instead
	 */
	@Deprecated
	int clGetGLObjectInfo(cl_mem mem, IntByReference cl_gl_object_typePtr1, IntByReference GLuintPtr1);
	/**
	 * Original signature : <code>cl_int clGetGLObjectInfo(cl_gl_object_type*, GLuint*)</code><br>
	 ...
	 */
	int clGetGLObjectInfo(cl_mem mem, IntBuffer cl_gl_object_typePtr1, IntBuffer GLuintPtr1);
	/**
	 ...
	 * @deprecated use the safer method {@link #clEnqueueAcquireGLObjects(int, OpenCLLibrary.cl_mem[], int, OpenCLLibrary.cl_event[], OpenCLLibrary.cl_event[])} instead
	 */
	@Deprecated
	int clEnqueueAcquireGLObjects(cl_command_queue queue, int cl_uint1, PointerByReference cl_memPtr1, int cl_uint2, PointerByReference cl_eventPtr1, PointerByReference cl_eventPtr2);
	/**
	 * Original signature : <code>cl_int clEnqueueAcquireGLObjects(cl_uint, const cl_mem*, cl_uint, const cl_event*, cl_event*)</code><br>
	 ...
	 */
	int clEnqueueAcquireGLObjects(cl_command_queue queue, int cl_uint1, OpenCLLibrary.cl_mem cl_memPtr1[], int cl_uint2, OpenCLLibrary.cl_event cl_eventPtr1[], OpenCLLibrary.cl_event cl_eventPtr2[]);
	/**
	 ...
	 * @deprecated use the safer method {@link #clEnqueueReleaseGLObjects(int, OpenCLLibrary.cl_mem[], int, OpenCLLibrary.cl_event[], OpenCLLibrary.cl_event[])} instead
	 */
	@Deprecated
	int clEnqueueReleaseGLObjects(cl_command_queue queue, int cl_uint1, PointerByReference cl_memPtr1, int cl_uint2, PointerByReference cl_eventPtr1, PointerByReference cl_eventPtr2);
	/**
	 * Original signature : <code>cl_int clEnqueueReleaseGLObjects(cl_uint, const cl_mem*, cl_uint, const cl_event*, cl_event*)</code><br>
	 ...
	 */
	int clEnqueueReleaseGLObjects(cl_command_queue queue, int cl_uint1, OpenCLLibrary.cl_mem cl_memPtr1[], int cl_uint2, OpenCLLibrary.cl_event cl_eventPtr1[], OpenCLLibrary.cl_event cl_eventPtr2[]);
	...
	int clGetGLContextInfoKHR(NativeSizeByReference properties, int param_name, NativeSize param_value_size, Pointer param_value, NativeSizeByReference param_value_size_ret);
	/// Pointer to unknown (opaque) type
	public static class cl_device_id extends PointerType {
		public  cl_device_id(Pointer pointer) {
			super(pointer);
		}
		public  cl_device_id() {
			super();
	...
	public static class cl_event extends PointerType {
		public  cl_event(Pointer pointer) {
			super(pointer);
		}
		public  cl_event() {
			super();
	...
	public static class cl_platform_id extends PointerType {
		public  cl_platform_id(Pointer pointer) {
			super(pointer);
		}
	...
	public static class cl_command_queue extends PointerType {
		public  cl_command_queue(Pointer pointer) {
			super(pointer);
		}
	...
	public static class cl_context extends PointerType {
		public  cl_context(Pointer pointer) {
			super(pointer);
		}
		public  cl_context() {
			super();
	...
	public static class cl_sampler extends PointerType {
		public  cl_sampler(Pointer pointer) {
			super(pointer);
		}
		public  cl_sampler() {
			super();
	...
	public static class cl_program extends PointerType {
		public  cl_program(Pointer pointer) {
			super(pointer);
		}
		public  cl_program() {
			super();
	...
	public static class cl_kernel extends PointerType {
		public  cl_kernel(Pointer pointer) {
			super(pointer);
		}
		public  cl_kernel() {
			super();
