...
/**
 * OpenCL4Java is a thin Java wrapper around OpenCL's C API.<br>
 * It uses JNA as its interop layer library, which means it works on all of the (many) JNA-supported platforms (see http://jna.dev.java.net/).<br>
 * It is autogenerated by JNAerator (http://jnaerator.googlecode.com/), so updates to newer OpenCL specs are a matter of seconds.<br>
 * Note that OpenCL4Java is used by JavaCL, an Object-Oriented API that presents OpenCL in a much more practical, powerful and idiomatic way to Java.<br>
 * For more info, please visit the <a href="http://code.google.com/p/nativelibs4java/wiki/OpenCL">OpenCL subproject at NativeLibs4Java</a>.<br>
 */
