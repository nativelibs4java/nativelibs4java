...
public class OpenCLLibrary {
	...
	public static abstract class clGetGLContextInfoKHR_fn extends Callback {
		public native int clGetGLContextInfoKHR_fn(Pointer<SizeT > properties, int param_name, @Ptr long param_value_size, Pointer<? > param_value, Pointer<SizeT > param_value_size_ret);
	};
	public static abstract class clIcdGetPlatformIDsKHR_fn extends Callback {
		public native int clIcdGetPlatformIDsKHR_fn(int cl_uint1, Pointer<OpenCLLibrary.cl_platform_id > cl_platform_idPtr1, Pointer<java.lang.Integer > cl_uintPtr1);
	};
	public static abstract class clReleaseDeviceEXT_fn extends Callback {
		public native int clReleaseDeviceEXT_fn(OpenCLLibrary.cl_device_id cl_device_id1);
	};
	public static abstract class clRetainDeviceEXT_fn extends Callback {
		public native int clRetainDeviceEXT_fn(OpenCLLibrary.cl_device_id cl_device_id1);
	};
	public static abstract class clCreateContext_arg1_callback extends Callback {
		public native void clCreateContext_arg1_callback(Pointer<java.lang.Byte > charPtr1, Pointer<? > voidPtr1, @Ptr long size_t1, Pointer<? > voidPtr2);
	};
	public static abstract class clCreateContextFromType_arg1_callback extends Callback {
		public native void clCreateContextFromType_arg1_callback(Pointer<java.lang.Byte > charPtr1, Pointer<? > voidPtr1, @Ptr long size_t1, Pointer<? > voidPtr2);
	};
	public static abstract class clSetMemObjectDestructorCallback_arg1_callback extends Callback {
		public native void clSetMemObjectDestructorCallback_arg1_callback(OpenCLLibrary.cl_mem cl_mem1, Pointer<? > voidPtr1);
	};
	public static abstract class clBuildProgram_arg1_callback extends Callback {
		public native void clBuildProgram_arg1_callback(OpenCLLibrary.cl_program cl_program1, Pointer<? > voidPtr1);
	};
	public static abstract class clSetEventCallback_arg1_callback extends Callback {
		public native void clSetEventCallback_arg1_callback(OpenCLLibrary.cl_event cl_event1, int cl_int1, Pointer<? > voidPtr1);
	};
	public static abstract class user_func extends Callback {
		public native void user_func(Pointer<? > voidPtr1);
	};
	public static abstract class clSetMemObjectDestructorAPPLE_arg1_callback extends Callback {
		public native void clSetMemObjectDestructorAPPLE_arg1_callback(OpenCLLibrary.cl_mem cl_mem1, Pointer<? > voidPtr1);
	};
	public static abstract class clCreateSubDevicesEXT_fn_callback extends Callback {
		public native int clCreateSubDevicesEXT_fn_callback(OpenCLLibrary.cl_device_id cl_device_id1, Pointer<java.lang.Long > cl_device_partition_property_extPtr1, int cl_uint1, Pointer<OpenCLLibrary.cl_device_id > cl_device_idPtr1, Pointer<java.lang.Integer > cl_uintPtr1);
	};
	...
	public native static OpenCLLibrary.cl_context clCreateContext(Pointer<SizeT > cl_context_propertiesPtr1, int cl_uint1, Pointer<OpenCLLibrary.cl_device_id > cl_device_idPtr1, Pointer<OpenCLLibrary.clCreateContext_arg1_callback > arg1, Pointer<? > voidPtr1, Pointer<java.lang.Integer > cl_intPtr1);
	public native static OpenCLLibrary.cl_context clCreateContextFromType(Pointer<SizeT > cl_context_propertiesPtr1, long cl_device_type1, Pointer<OpenCLLibrary.clCreateContextFromType_arg1_callback > arg1, Pointer<? > voidPtr1, Pointer<java.lang.Integer > cl_intPtr1);
	...
	public native static OpenCLLibrary.cl_mem clCreateSubBuffer(OpenCLLibrary.cl_mem cl_mem1, long cl_mem_flags1, int cl_buffer_create_type1, Pointer<? > voidPtr1, Pointer<java.lang.Integer > cl_intPtr1);
	...
	public native static int clSetMemObjectDestructorCallback(OpenCLLibrary.cl_mem cl_mem1, Pointer<OpenCLLibrary.clSetMemObjectDestructorCallback_arg1_callback > arg1, Pointer<? > voidPtr1);
	...
	public native static int clBuildProgram(OpenCLLibrary.cl_program cl_program1, int cl_uint1, Pointer<OpenCLLibrary.cl_device_id > cl_device_idPtr1, Pointer<java.lang.Byte > charPtr1, Pointer<OpenCLLibrary.clBuildProgram_arg1_callback > arg1, Pointer<? > voidPtr1);
	...
	public native static OpenCLLibrary.cl_event clCreateUserEvent(OpenCLLibrary.cl_context cl_context1, Pointer<java.lang.Integer > cl_intPtr1);
	...
	public native static int clSetUserEventStatus(OpenCLLibrary.cl_event cl_event1, int cl_int1);
	public native static int clSetEventCallback(OpenCLLibrary.cl_event cl_event1, int cl_int1, Pointer<OpenCLLibrary.clSetEventCallback_arg1_callback > arg1, Pointer<? > voidPtr1);
	...
	public native static int clEnqueueReadBufferRect(OpenCLLibrary.cl_command_queue cl_command_queue1, OpenCLLibrary.cl_mem cl_mem1, int cl_bool1, Pointer<SizeT > size_tPtr1, Pointer<SizeT > size_tPtr2, Pointer<SizeT > size_tPtr3, @Ptr long size_t1, @Ptr long size_t2, @Ptr long size_t3, @Ptr long size_t4, Pointer<? > voidPtr1, int cl_uint1, Pointer<OpenCLLibrary.cl_event > cl_eventPtr1, Pointer<OpenCLLibrary.cl_event > cl_eventPtr2);
	...
	public native static OpenCLLibrary.cl_mem clCreateFromGLBuffer(OpenCLLibrary.cl_context cl_context1, long cl_mem_flags1, int cl_GLuint1, Pointer<java.lang.Integer > intPtr1);
	public native static OpenCLLibrary.cl_mem clCreateFromGLTexture2D(OpenCLLibrary.cl_context cl_context1, long cl_mem_flags1, int cl_GLenum1, int cl_GLint1, int cl_GLuint1, Pointer<java.lang.Integer > cl_intPtr1);
	public native static OpenCLLibrary.cl_mem clCreateFromGLTexture3D(OpenCLLibrary.cl_context cl_context1, long cl_mem_flags1, int cl_GLenum1, int cl_GLint1, int cl_GLuint1, Pointer<java.lang.Integer > cl_intPtr1);
	public native static OpenCLLibrary.cl_mem clCreateFromGLRenderbuffer(OpenCLLibrary.cl_context cl_context1, long cl_mem_flags1, int cl_GLuint1, Pointer<java.lang.Integer > cl_intPtr1);
	public native static int clGetGLObjectInfo(OpenCLLibrary.cl_mem cl_mem1, Pointer<java.lang.Integer > cl_gl_object_typePtr1, Pointer<java.lang.Integer > cl_GLuintPtr1);
	...
	public native static int clGetGLContextInfoKHR(Pointer<SizeT > cl_context_propertiesPtr1, int cl_gl_context_info1, @Ptr long size_t1, Pointer<? > voidPtr1, Pointer<SizeT > size_tPtr1);
	...
	public native static OpenCLLibrary.cl_event clCreateEventFromGLsyncKHR(OpenCLLibrary.cl_context cl_context1, OpenCLLibrary.cl_GLsync cl_GLsync1, Pointer<java.lang.Integer > cl_intPtr1);
	public native static int clSetMemObjectDestructorAPPLE(OpenCLLibrary.cl_mem cl_mem1, Pointer<OpenCLLibrary.clSetMemObjectDestructorAPPLE_arg1_callback > arg1, Pointer<? > voidPtr1);
	public native static void clLogMessagesToSystemLogAPPLE(Pointer<java.lang.Byte > charPtr1, Pointer<? > voidPtr1, @Ptr long size_t1, Pointer<? > voidPtr2);
	public native static void clLogMessagesToStdoutAPPLE(Pointer<java.lang.Byte > charPtr1, Pointer<? > voidPtr1, @Ptr long size_t1, Pointer<? > voidPtr2);
	public native static void clLogMessagesToStderrAPPLE(Pointer<java.lang.Byte > charPtr1, Pointer<? > voidPtr1, @Ptr long size_t1, Pointer<? > voidPtr2);
	public native static int clIcdGetPlatformIDsKHR(int cl_uint1, Pointer<OpenCLLibrary.cl_platform_id > cl_platform_idPtr1, Pointer<java.lang.Integer > cl_uintPtr1);
	public native static int clReleaseDeviceEXT(OpenCLLibrary.cl_device_id cl_device_id1);
	public native static int clRetainDeviceEXT(OpenCLLibrary.cl_device_id cl_device_id1);
	public native static int clCreateSubDevicesEXT(OpenCLLibrary.cl_device_id cl_device_id1, Pointer<java.lang.Long > cl_device_partition_property_extPtr1, int cl_uint1, Pointer<OpenCLLibrary.cl_device_id > cl_device_idPtr1, Pointer<java.lang.Integer > cl_uintPtr1);
