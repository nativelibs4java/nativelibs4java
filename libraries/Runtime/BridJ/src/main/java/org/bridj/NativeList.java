...
public class NativeList<T> implements List<T> {
     ...
     * @param capacity 
     */
    public NativeList(PointerIO<T> io, long capacity) {
        this(allocateArray(io, capacity), ListType.Dynamic);
        clear();
    }
     ...
     */
    public NativeList(Pointer<T> pointer, ListType type) {
    ...
    private class SubList implements List<T> {
        ...
        public boolean contains(Object o) {
            return NativeList.this.indexOf(o, false, fromIndex) < size();
        }
        ...
        public boolean remove(Object o) {
            ...
            NativeList.this.remove(fromIndex + i);
            return true;
        }
        ...
        public T get(int i) {
            checkIndex(i);
            return NativeList.this.get(fromIndex + i);
        }

        public T set(int i, T e) {
            checkIndex(i);
            return NativeList.this.set(fromIndex + i, e);
        }

        public void add(int i, T e) {
            NativeList.this.add(i + toIndex++, e);
        }
        ...
        public T remove(int i) {
            checkIndex(i);
            T old = get(i);
            NativeList.this.remove(i + fromIndex);
            toIndex--;
            return old;
        }

        public int indexOf(Object o) {
            long i = NativeList.this.indexOf(o, false, fromIndex);
            if (i < 0 || i >= toIndex)
                return -1;
        ...
        public int lastIndexOf(Object o) {
            long i = NativeList.this.indexOf(o, true, 0); // TODO handle from index here
