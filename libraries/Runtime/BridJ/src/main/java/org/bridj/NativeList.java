...
list (it depends on the list's implementation : for instance {@link vector}.getPointer() will return a pointer to the vector structure's pointer, while a list created out of a pointer through {@link Pointer#toList() } will return their storage pointer)
 * @author ochafik
 */
...
list.<br>
     ...
     * while a list created out of a pointer through {@link Pointer#toList() } will return their storage pointer)
     */
