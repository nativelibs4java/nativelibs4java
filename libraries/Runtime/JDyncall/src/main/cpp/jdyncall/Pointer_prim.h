...
jprimName JNICALL CONCAT_2(Java_com_nativelibs4java_runtime_Pointer_get_1, primName)(JNIEnv *env, jobject, jlong peer, jbyte endianness) {
	BEGIN_TRY();
...
jprimArray JNICALL CONCAT_3(Java_com_nativelibs4java_runtime_Pointer_get_1, primName, _1array)(JNIEnv *env, jobject, jlong peer, jint length, jbyte endianness) {
	BEGIN_TRY();
	//TODO handle endianness
