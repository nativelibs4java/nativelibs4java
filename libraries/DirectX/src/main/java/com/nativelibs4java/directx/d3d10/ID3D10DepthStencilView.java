...
/**
 * <i>native declaration : d3d10.h:692</i><br>
...
@Library("d3d10") 
public class ID3D10DepthStencilView extends ID3D10View {
	public ID3D10DepthStencilView() {
		super();
	}
	public ID3D10DepthStencilView(Pointer pointer) {
		super(pointer);
	}
	@Virtual(0) 
	public native void GetDesc(Pointer<D3D10_DEPTH_STENCIL_VIEW_DESC > pDesc);
}
