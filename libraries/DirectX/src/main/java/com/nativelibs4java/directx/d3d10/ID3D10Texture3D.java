...
/**
 * <i>native declaration : d3d10.h:501</i><br>
...
@Library("d3d10") 
public class ID3D10Texture3D extends ID3D10Resource {
	public ID3D10Texture3D() {
		super();
	}
	public ID3D10Texture3D(Pointer pointer) {
		super(pointer);
	}
	@Virtual(0) 
	public native int Map(int Subresource, ValuedEnum<D3D10_MAP > MapType, int MapFlags, Pointer<D3D10_MAPPED_TEXTURE3D > pMappedTex3D);
	@Virtual(1) 
	public native void Unmap(int Subresource);
	@Virtual(2) 
	public native void GetDesc(Pointer<D3D10_TEXTURE3D_DESC > pDesc);
}
