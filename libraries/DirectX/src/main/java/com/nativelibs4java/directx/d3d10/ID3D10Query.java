...
/**
 * <i>native declaration : d3d10.h:840</i><br>
...
@Library("d3d10") 
public class ID3D10Query extends ID3D10Asynchronous {
	public ID3D10Query() {
		super();
	}
	public ID3D10Query(Pointer pointer) {
		super(pointer);
	}
	@Virtual(0) 
	public native void GetDesc(Pointer<D3D10_QUERY_DESC > pDesc);
}
