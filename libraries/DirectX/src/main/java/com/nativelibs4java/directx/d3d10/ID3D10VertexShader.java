...
/**
 * <i>native declaration : d3d10.h:698</i><br>
...
@Library("d3d10") 
public class ID3D10VertexShader extends ID3D10DeviceChild {
	public ID3D10VertexShader() {
		super();
	}
	public ID3D10VertexShader(Pointer pointer) {
		super(pointer);
	}
}
