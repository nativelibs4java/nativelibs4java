...
/**
 * <i>native declaration : d3d10.h:811</i><br>
...
@Library("d3d10") 
public class ID3D10Asynchronous extends ID3D10DeviceChild {
	public ID3D10Asynchronous() {
		super();
	}
	public ID3D10Asynchronous(Pointer pointer) {
		super(pointer);
	}
	@Virtual(0) 
	...
	@Virtual(2) 
	public native int GetData(Pointer<? > pData, int DataSize, int GetDataFlags);
	@Virtual(3) 
