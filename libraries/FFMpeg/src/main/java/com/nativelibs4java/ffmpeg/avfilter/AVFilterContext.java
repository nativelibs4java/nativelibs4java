 ...
 * <i>native declaration : libavfilter/avfilter.h:536</i><br>
...
public class AVFilterContext extends StructObject {
	...
	/// C type : AVFilter*
	public final Pointer<AVFilter > filter_$eq(Pointer<AVFilter > filter) {
		filter(filter);
		return filter;
	}
	/**
	...
	/// C type : AVFilterPad*
	public final Pointer<AVFilterPad > input_pads_$eq(Pointer<AVFilterPad > input_pads) {
	...
	/// C type : AVFilterLink**
	public final Pointer<Pointer<AVFilterLink > > inputs_$eq(Pointer<Pointer<AVFilterLink > > inputs) {
		inputs(inputs);
		return inputs;
	}
	...
	/// C type : AVFilterPad*
	public final Pointer<AVFilterPad > output_pads_$eq(Pointer<AVFilterPad > output_pads) {
	...
	/// C type : AVFilterLink**
	public final Pointer<Pointer<AVFilterLink > > outputs_$eq(Pointer<Pointer<AVFilterLink > > outputs) {
		outputs(outputs);
		return outputs;
	}
	/**
