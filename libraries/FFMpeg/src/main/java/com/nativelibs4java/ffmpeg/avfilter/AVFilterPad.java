 ...
 * <i>native declaration : libavfilter/avfilter.h:264</i><br>
...
public class AVFilterPad extends StructObject {
	 ...
	 */
	@Field(0) 
	public AVFilterPad name(Pointer<java.lang.Byte > name) {
	...
	/**
	 * AVFilterPad type. Only video supported now, hopefully someone will<br>
	 * add audio in the future.<br>
	 * C type : AVMediaType
	 */
	@Field(1) 
	 ...
	 */
	@Field(1) 
	public AVFilterPad type(ValuedEnum<AVMediaType > type) {
	...
	/**
	 * Callback function to get a buffer. If NULL, the filter system will<br>
	...
	public AVFilterPad end_frame(Pointer<AVFilterPad.end_frame_callback > end_frame) {
		this.io.setPointerField(this, 6, end_frame);
		return this;
	}
	/// C type : end_frame_callback
	...
	public AVFilterPad draw_slice(Pointer<AVFilterPad.draw_slice_callback > draw_slice) {
		this.io.setPointerField(this, 7, draw_slice);
		return this;
	}
	/// C type : draw_slice_callback
	 ...
	 * frames. It should return a positive value if the next request_frame()<br>
	...
	public AVFilterPad poll_frame(Pointer<AVFilterPad.poll_frame_callback > poll_frame) {
		this.io.setPointerField(this, 8, poll_frame);
		return this;
	}
	/// C type : poll_frame_callback
	...
	public AVFilterPad request_frame(Pointer<AVFilterPad.request_frame_callback > request_frame) {
		this.io.setPointerField(this, 9, request_frame);
		return this;
	}
	/// C type : request_frame_callback
	...
	public AVFilterPad config_props(Pointer<AVFilterPad.config_props_callback > config_props) {
		this.io.setPointerField(this, 10, config_props);
		return this;
	}
	/// C type : config_props_callback
	...
	public static abstract class start_frame_callback extends Callback<start_frame_callback > {
		public abstract void apply(Pointer<com.nativelibs4java.ffmpeg.avfilter.AVFilterLink > link, Pointer<com.nativelibs4java.ffmpeg.avfilter.AVFilterPicRef > picref);
	};
	/// <i>native declaration : libavfilter/avfilter.h:314</i>
	public static abstract class get_video_buffer_callback extends Callback<get_video_buffer_callback > {
		public abstract Pointer<com.nativelibs4java.ffmpeg.avfilter.AVFilterPicRef > apply(Pointer<com.nativelibs4java.ffmpeg.avfilter.AVFilterLink > link, int perms, int w, int h);
	};
	/// <i>native declaration : libavfilter/avfilter.h:323</i>
	public static abstract class end_frame_callback extends Callback<end_frame_callback > {
		public abstract void apply(Pointer<com.nativelibs4java.ffmpeg.avfilter.AVFilterLink > link);
	};
	/// <i>native declaration : libavfilter/avfilter.h:331</i>
	public static abstract class draw_slice_callback extends Callback<draw_slice_callback > {
		public abstract void apply(Pointer<com.nativelibs4java.ffmpeg.avfilter.AVFilterLink > link, int y, int height, int slice_dir);
	};
	/// <i>native declaration : libavfilter/avfilter.h:342</i>
	public static abstract class poll_frame_callback extends Callback<poll_frame_callback > {
		public abstract int apply(Pointer<com.nativelibs4java.ffmpeg.avfilter.AVFilterLink > link);
	};
	/// <i>native declaration : libavfilter/avfilter.h:351</i>
	public static abstract class request_frame_callback extends Callback<request_frame_callback > {
		public abstract int apply(Pointer<com.nativelibs4java.ffmpeg.avfilter.AVFilterLink > link);
	};
	/// <i>native declaration : libavfilter/avfilter.h:367</i>
